 ...
 * Fall 2015
 *
 * Note: You need at least Java 7 to run this tester!
 *
...
public class HW2Tester {
	...
	private static TestCase testCases[] = {
		...
		new TestCase("bitRange", 0x00000004, 0x00001234, 0, 4,
		                         0x00000023, 0x00001234, 4, 8,
		                         0x0000002A, 0x55555555, 5, 7),
	...
	private static void test_bitRange(TestCase t) {
		...
		for(int i = 0; i < t.tests.length; i += 4) {
			...
			int arg2 = (Integer) t.tests[i + 2];
			int arg3 = (Integer) t.tests[i + 3];
			int res = HW2Operations.bitRange(arg1, arg2, arg3);
			boolean cor = exp == res;
			if(cor) {
				++score;
			}
			pw.printf("%s(%8X, %2d, %2d): Expected: %8X Result: %8X Correct: %5b\n", t.name, arg1, arg2, arg3, exp, res, cor);
			pw.flush();
		}
